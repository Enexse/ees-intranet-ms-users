        ...
        <tr>
            <td align="center" valign="center" style="text-align:center; padding: 40px">
                <a href="http://www.enexse.com/" rel="noopener" target="_blank">
                    <img src="https://enexse-demo.netlify.app/assets/images/EES-logoWeb-primary.png" alt="Logo Enexse"  style="width: 50%"/>
                </a>
            </td>
        </tr>
        <tr>
            <td align="left" valign="center">
                <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
                    ...
                    <div style="padding-bottom: 30px">To activate your account, please click on the button below to verify your email address. Once activated, you’ll have full access to our Intranet Platform.</div>
                    ...
                    <div style="padding-bottom: 30px">This certification link will expire in <b>15 minutes.</b> After expiring, if you did not request other confirmation link, no further action will be done.</div>
                    <div style="border-bottom: 1px solid #eeeeee; margin: 15px 0"></div>
                    <div style="padding-bottom: 50px; word-wrap: break-all;">
                        <p style="margin-bottom: 10px;">Button not working? Try coping and pasting this URL into your browser:</p>
