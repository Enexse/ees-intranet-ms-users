        ...
        <tr>
            <td align="left" valign="center">
                <div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
                    ...
                    <div style="padding-bottom: 30px">You have been invited to change your password!
                         To change your password, click in the button below:
                    </div>
                    ...
                    <div style="padding-bottom: 30px">This reset password link will expire in <b>15 minutes.</b> After expiring, if you did not request other confirmation link, no further action will be done.</div>
